...
public interface IAgendamentoService
{
    ...
    Task<IReadOnlyList<AgendamentoDto>> ListarAsync(Guid usuarioId, DateTime? inicio, DateTime? fim, CancellationToken ct);
    Task<IReadOnlyList<AgendamentoDto>> ListarPorClienteAsync(Guid usuarioId, Guid clienteId, CancellationToken ct);
